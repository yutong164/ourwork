Page({
  ...
  getDataFromOneNet: function () {
    //从oneNET请求我们的心率传感器的数据
    const requestTask = wx.request({
      url: 'https://api.heclouds.com/devices/509005127/datapoints?datastream_id=Light,Temperature,Humidity&limit=15',
      header: {
        'content-type': 'application/json',
        'api-key': '1T1NEOqama8brgaz==TU4oCTphA='
      },
      success: function (res) {
        ...
        wx.navigateTo({
          url: '../wifi_station_heart/tianqi/tianqi',
        })
      },
